...
bool bbb_interfaces__msg__bbb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bbb_interfaces.msg._bbb.Bbb", full_classname_dest, 27) == 0);
  }
  bbb_interfaces__msg__Bbb * ros_message = _ros_message;
  {  // linear
...
{
  /* NOTE(esteve): Call constructor of Bbb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bbb_interfaces.msg._bbb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Bbb");
