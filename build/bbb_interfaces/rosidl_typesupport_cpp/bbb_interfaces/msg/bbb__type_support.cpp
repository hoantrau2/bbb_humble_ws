...
static const _Bbb_type_support_symbol_names_t _Bbb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bbb_interfaces, msg, Bbb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bbb_interfaces, msg, Bbb)),
  }
};
...
{
  return &::bbb_interfaces::msg::rosidl_typesupport_cpp::Bbb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bbb_interfaces, msg, Bbb)() {
  return get_message_type_support_handle<bbb_interfaces::msg::Bbb>();
}
